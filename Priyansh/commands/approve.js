  ...
  switch (type) {
        case "pending": {
          switch (body) {
   			...
   			api.sendMessage(`लो दे दिया अप्रूवल विवेक बाबू 🙂🤟\n${idBox}`, threadID, () => {
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("आपका ग्रुप अप्रूवल कर दिया है विवेक विश्वकर्मा जी ने 🙂\n✧═════════•❁❀❁•═════════✧\n💖 मस्ती करो अब 💖\n✧═════════•❁❀❁•═════════✧\n 💝🥀𝐎𝐖𝐍𝐄𝐑 :-  ☞Vɩvɘĸ Vɩsʜwʌĸʌʀɱʌ☜\n✧═════════•❁❀❁•═════════✧\nआपका दिल की धड़कन     💋Vɩvɘĸ Vɩsʜwʌĸʌʀɱʌ💋\n✧═════════•❁❀❁•═════════✧\nफेसबुक 🆔 :- 👇\n\https://www.facebook.com/sahe.aalam.1042?mibextid=JRoKGi\n✧═════════•❁❀❁•═════════✧\nकिसी भी तरह की हेल्प के लिए कांटेक्ट करे 👉 [+91 95011XXXX8]", idBox, (error, info) => {
